...
private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            String sql = "INSERT INTO supplier (id_supplier, nama_supplier, alamat_supplier, jenis_bahan, no_tlp) VALUES (?, ?, ?, ?, ?)";
            ...
            clearForm();
            // loadTable(); // optional, isi ulang JTable
...
private void clearForm() {
    ...
    // Method initComponents dan komponen form di-generate otomatis NetBeans
private void loadTable() {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ikan", "Tepung", "Bumbu", "Minuman (Air Putih)", "Kemasan (Plastik, Sendok, Kotak)", "Minyak Goreng", "Sayur" }));
        ...
        jMenuItem4.setText("DataPegawai");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
try {
        // Query SQL untuk insert data ke tabel supplier
        String sql = "INSERT INTO supplier (id_supplier, nama_supplier, alamat_supplier, jenis_bahan, no_tlp) VALUES (?, ?, ?, ?, ?)";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         try {
        String sql = "UPDATE supplier SET nama_supplier=?, alamat_supplier=?, jenis_bahan=?, no_tlp=? WHERE id_supplier=?";
        pst = conn.prepareStatement(sql);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        pst = conn.prepareStatement(sql);
        pst.setString(1, jTextField1.getText()); // ID Supplier
        pst.executeUpdate();
        JOptionPane.showMessageDialog(null, "Data berhasil dihapus!");

        clearForm();     // kosongkan form
        loadTable();     // refresh JTable agar data hilang
    } catch (SQLException e) {
        JOptionPane.showMessageDialog(null, "Gagal: " + e.getMessage());
    }
